package br.com.generation.poo2;

public class TestaAvião2 {

	public static void main(String[] args) {
		
		Exercicio2Avião cliente1 = new Exercicio2Avião();
		Exercicio2Avião cliente2 = new Exercicio2Avião();
		
		cliente1.companhia = "Azul";
		cliente1.origem = "São Paulo";
		cliente1.destino = "Ilhéus";
		cliente1.nome = "Santos, Júlia";
		cliente1.assento = "A6";
		cliente1.quantBagagem = 2;
		cliente1.pesoBagagem= 19.99;
		
		cliente2.companhia = "LATAM";
		cliente2.origem = "Rio de Janeiro";
		cliente2.destino = "Curitiba";
		cliente2.nome = "Tijon, Giovanna";
